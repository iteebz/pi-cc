#!/usr/bin/env bash
# A/B usage comparison: pi-cc-bridge vs Claude Code direct.
...
build_prompts() {
  ...
  PROMPTS+=("Read README.md and explain the architecture — how does the provider work?")
